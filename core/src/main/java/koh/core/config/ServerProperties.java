...
import koh.core.helper.ConfigLoader;
import lombok.Data;
...
public class ServerProperties {
    ...
    public static ServerProperties getConfig(String file) {
        ...
        return new ServerProperties(
                ...
                properties.getProperty("server.routePackage")
        );
    }
}
