        ...
        <div class="col">
            ...
            <div class="form-horizontal content-loading">
                ...
                <table class="table table-bordered table-hover table-responsive-sm">
                    ...
                    @if ($campFreqCapOverrideData->count() > 0)
                        @foreach ($campFreqCapOverrideData as $item)
    ...
    <div class="row">
        <div class="col-7">
            <div class="float-left">
                {!! $campFreqCapOverrideData->total() !!} {{ __('labels.backend.total') }}
            </div>
        </div>
        <div class="col-5">
            <div class="float-right">
                {!! $campFreqCapOverrideData->links() !!}
            </div>
        </div>
    </div>
</div>
