        ...
        <div class="col">
            ...
            <div class="form-horizontal content-loading">
                ...
                <table class="table table-bordered table-hover table-responsive-sm">
                    ...
                    @if ($campaignWithPriorityData->count() > 0)
                        @foreach ($campaignWithPriorityData as $item)
    ...
    <div class="row">
        <div class="col-7">
            <div class="float-left">
                {!! $campaignWithPriorityData->total() !!} {{ __('labels.backend.total') }}
            </div>
        </div>
        <div class="col-5">
            <div class="float-right">
                {!! $campaignWithPriorityData->links() !!}
            </div>
        </div>
    </div>
</div>
